        ...
        <div class="box-center">
            <div class="sub1">
                <div class="box1">
                    ...
                    <div class="right"><p><a class="a1" style="color: white;" href="../admin2/dashboard.php">Logo</a></p></div>
                </div>
    ...
    <div class="box-content-right">
        <div class="box-light">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="">Type of Photo</label>
                                <input type="file" name="txt-photo" id="" class="form-control">
                            </div>
                            <div class="form-group">
            ...
            <div style="width: 85%;margin-left:13%;margin-top:20px;">
                    <table id="example" class="table w-100 text-light table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Photo</th>
                                    ...
                                    while($row = $rs->fetch_array()){
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img style="width: 50px; height: 40px;" src="../upload/<?php echo $row[1];?>" alt="">
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="button" name="btn-delete" value="Delete" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#DeleteModal<?=$row[0]?>">
                                                </td>
                                            </tr>      
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="text" name="txt-id" id="" value="<?php echo $row[0]; ?>" class="form-control">
                                        <input type="text" name="txt-tmp" id="" value="<?php echo $row['photo'];?>">
                                        <label for="">Type of Photo</label>
                                        <input type="file" name="txt-photo" id="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" name="btn-update" class="btn btn-primary">Upload</button>
                                </form>
                            </div>
                            </div>
                        </div>
